...
#ifndef SRC__RMF_FLEET_ADAPTER__TASKS__BOOKSHELF_HPP
#define SRC__RMF_FLEET_ADAPTER__TASKS__BOOKSHELF_HPP
...
#endif // SRC__RMF_FLEET_ADAPTER__TASKS__BOOKSHELF_HPP
